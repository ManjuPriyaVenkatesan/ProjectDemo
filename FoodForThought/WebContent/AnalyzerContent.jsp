	...
	<div class="whole-wrap">
		<div class="container box_1170">
			...
			<div class="section-top-border">
				<h3 class="mb-30">Content Analysis</h3>
		...
		<%
			...
			while(rs.next())
			{
					...
					for (String a : count_words) 
					{
						...
						PreparedStatement ps1=con.prepareStatement("SELECT words FROM `foodforthought`.`nonpromisingdata` where words = ?");
						ps1.setString(1,a);
		 ...
		 <%}%>
		  <% if(fake_count > 0) 
			...
			try
			{
				PreparedStatement obj1 = con1.prepareStatement("INSERT INTO `foodforthought`.`content` VALUES(?,?,?,?)");
				obj1.setString(1, Integer.toString(fake_count));
				obj1.setString(2, text1);
				obj1.setString(3, text);
