...
<body>
  ...
  <section class="contact-section section_padding">
    <div class="container">
      ...
      <div class="row">
        <div class="col-12">
          <h2 class="contact-title">Analyzer Credentials</h2>
          <br>
        </div>
        <div class="col-lg-8">
          <form class="form-contact contact_form" action="AdminLoginServlet" method="post">
            <div class="row">
            ...
            <div class="form-group mt-3">
              <button type="submit" class="btn_3">Login<i
