	...
	<div class="whole-wrap">
		<div class="container box_1170">
			...
			<div class="section-top-border">
				<h3 class="mb-30">Writing Style Analysis</h3>
		...
		<%
			...
			while(rs.next())
			{
					...
					for (String a : count_words) 
					{
						...
						PreparedStatement ps1=con.prepareStatement("SELECT style FROM `foodforthought`.`nonpromisingdata` where style = ?");
						ps1.setString(1,a);
		 ...
		 <%}%>
		  <% if(fake_count > 0) 
			...
			try
			{
				PreparedStatement obj1 = con1.prepareStatement("INSERT INTO `foodforthought`.`writingstyle` VALUES(?,?,?,?)");
				obj1.setString(1, Integer.toString(fake_count));
				obj1.setString(2, text);
				obj1.setString(3, text2);
				obj1.setString(4, text3);
