...
String hosterhousewheelchairaccessible_onvalued = "NA";
...
int price = 0;
			...
			String sql = "SELECT * FROM `tape`.`hosterhosthouse` JOIN `tape`.`userbookeddetails` WHERE hosterhosthouse.hosterhouseid = userbookeddetails.houseid";
