...
int price = 0;
			...
			String sql = "SELECT * FROM `tape`.`hosterhosthouse` JOIN `tape`.`usersearchhistory` WHERE hosterhosthouse.hosterhousecity = usersearchhistory.destination";
       ...
       %>						
				...
				<!-- Offers Item -->
						...
						<a href="UserBookHouse.jsp?id=<%=hosterhouseid%>&emailid=<%=emailid%>&hosteremailid=<%=hosterhouseemailid%>"><button type="submit" class="button book_button">&nbsp &nbsp &nbsp &nbsp <b> Book </b> &nbsp &nbsp &nbsp &nbsp </button><span></span><span></span><span></span></a>
