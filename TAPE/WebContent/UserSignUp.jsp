			...
			<div class="row">
				<div class="col">
					...
					<div class="contact_form_container">
						<div class="contact_title text-center">User Signup</div>
						<form action="UserRegistrationServlet" method="post" id="contact_form" class="contact_form text-center">
			...
			<div class="row">
				<div class="col">
					...
					<div class="contact_form_container">
						...
						<form action="UserLoginServlet" method="get" id="contact_form" class="contact_form text-center">
