				...
				<div class="col fill_height">
					...
					<div class="search_tabs_container">
						<div class="search_tabs d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
							<div class="search_tab active d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="images/suitcase.png" alt=""><span>house rentals</span></div>
					...
					<div class="search_panel active">
						<form action="UserViewHouseServlet" method = "post" id="search_form_1" class="search_panel_content d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
							...
							<div class="search_item">
								<div>check in</div>
								<input name="checkin" type="text" class="check_in search_input" placeholder="YYYY-MM-DD">
							</div>
							&nbsp&nbsp
							<div class="search_item">
								<div>check out</div>
								<input name="checkout" type="text" class="check_out search_input" placeholder="YYYY-MM-DD">
							</div>
							&nbsp&nbsp
							<div class="search_item">
								<div>adults</div>
							...
							<div class="search_item">
								<div>Email Id</div>
								<input name="emailid" type="text" class="check_in search_input" value ="<%=emailid%>">
							</div>
							&nbsp
