...
<br>
 ...
 <%			
			...
			String sql = "SELECT * FROM `tape`.`hosterregistration`";
       ...
       %>	    
							...
							<div class="owl-item cta_item text-center">
								<div class="cta_title">Hosters</div>
								<p class="cta_text">Hoster Phone No - <%=phoneno_view%></p>
								<p class="cta_text">Hoster Email Id - <%=emailid_view%></p>
								<p class="cta_text">Hoster Name - <%=username_view%></p>
