...
<br>
 ...
 <%			
			...
			String sql = "SELECT * FROM `tape`.`userregistration`";
       ...
       %>	    
							...
							<div class="owl-item cta_item text-center">
								<div class="cta_title">Users</div>
								<p class="cta_text">User Phone No - <%=phoneno_view%></p>
								<p class="cta_text">User Email Id - <%=emailid_view%></p>
								<p class="cta_text">User Name - <%=username_view%></p>
