...
<div>
		...
		<td><strong><font face="Eras Bold ITC" color="black"><center>NEGATIVE TWEET</center></font></strong></td> 
		</tr>
		 ...
		 <%}%>
		  ...
		  <% if(negative_count > 0) 
			...
			<tr>
			<td><font face="Comic Sans MS" color="#008080"><strong><%=negative_count%></strong></font></td>
			...
			try
			{
				PreparedStatement obj1 = con1.prepareStatement("INSERT INTO `sentidiff`.`negativetweet` VALUES(?,?)");
				obj1.setString(1, Integer.toString(negative_count));
